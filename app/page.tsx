    ...
    <>
      <main className="relative mx-auto flex min-h-screen max-w-screen-lg flex-col items-center justify-start px-4 text-center">
        ...
        <div className="my-auto space-y-4 py-10">
          ...
          <div className="mx-auto flex w-full max-w-screen-lg flex-wrap items-start justify-center gap-6 pt-10">
            {chats.map((chat, i) => (
              <div
                key={`chatType-${i}`}
                className="group flex w-44 flex-col items-center justify-start gap-2 self-stretch rounded-md border border-foreground/10 px-4 py-2 shadow-sm shadow-primary/30 transition-transform ease-in-out hover:scale-105 hover:shadow-primary/50"
              >
                <Link
                  href="/agent"
